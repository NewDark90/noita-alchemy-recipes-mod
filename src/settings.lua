...
mod_settings = 
{
	...
	},
    {
		...
		ui_name = "Open/Close Button Position",
        ui_description = "Where the button that shows or hides the recipes will be placed relative to the recipes themselves",
        value_default = "start",
    ...
    },
    {
		...
		ui_description = "Lively Concoction color in the UI",
		settings = {
            {
                id = "UI_RECIPE_LC_R",
                ui_name = "Red",
    ...
    {
        category_id = "UI_RECIPE_AP",
		ui_name = "Alchemic Precursor UI Color",
		ui_description = "Alchemic Precursor color in the UI",
		settings = {
            {
                id = "UI_RECIPE_AP_R",
                ui_name = "Red",
